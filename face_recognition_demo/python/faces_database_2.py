...
class FacesDatabase:
    ...
    def __init__(self, path, face_identifier, landmarks_detector, face_detector=None, no_show=False):
        ...
        for diretorio in dirs:
            ...
            t = threading.Thread(target=self.load_to_memory, args=(diretorio, face_identifier, landmarks_detector, face_detector,no_show))
            threads.append(t)
            t.start()
    ...
    def load_to_memory(self, path, face_identifier, landmarks_detector, face_detector=None, no_show=False):
        ...
        for path in paths:
            ...
            for roi in rois:
                ...
                #try:
                #    print("Descriptor: " + str(len(descriptor)))
                #except:
                #    pass                
                ...
                if face_detector:
                    ...
                    #log.debug("Adding label {} to the gallery".format(path + "/" +label))
